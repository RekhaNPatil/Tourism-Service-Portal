...
public class CheckPackage extends JFrame{
    CheckPackage(){
        setBounds(345,80,900,600);
        
        
        String[] package1={"GOLD PACKAGE","6 Das and 7 Nights","Airport Assistance","Half Day city Tour","Daily Buffet","Full Day 3 Island Cruise","English Speaking Guide","Horse Rifting","BOOK PACKAGE","SUMMER SPECIAL","Rs 12000/-","package1.jpg"};
        ...
        String[] package3={"BRONZE PACKAGE","Return Airfare","Free Clubbing","Horse Riding & other games","River rafting","Hard Drinks Free","Daily Buffet","Horse Rifting","BOOK NOW","MONSOON SPECIAL","Rs 34000/-","package3.jpg"};
